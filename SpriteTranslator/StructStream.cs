...
namespace AdvancedBinary {
    ...
    /// Array Length
    /// </summary>
    public class ArraySize : Attribute {
        public long Length;
    }
    ...
    internal class Const {
        ...
        public const string BYTEARR = "System.Byte[]";
        ...
        public const string ArrSize = "ArraySize";
    }  
    ...
    class StructReader : BinaryReader {
        ...
        private dynamic CheckReverse(dynamic Input) {
            if (BigEndian)
                return Tools.Reverse(Input);
            return Input;
        }
        ...
        private dynamic ReadValueByType(string Type) {
            switch (Type) {
                case Const.INT16:
                    return CheckReverse(ReadInt16());
                case Const.UINT16:
                    return CheckReverse(ReadUInt16());
                case Const.UINT8:
                    return ReadByte();
                case Const.INT8:
                    return ReadSByte();
                case Const.INT32:
                    return CheckReverse(ReadInt32());
                case Const.UINT32:
                    return CheckReverse(ReadUInt32());
                case Const.INT64:
                    return ReadInt64();
                default:
